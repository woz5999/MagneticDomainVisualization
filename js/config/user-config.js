var UserConfig = {
  ...
  iSizeRangeMax: 4800, //maximum number of particles
  ...
  iParticleColor: 'rgba(200, 200, 215, 1)', //fillcolor of particle
  ...
  //tweaks
  iFadeStrength: 0, //amount to fade particles with less magnetism
  iMagnetStrength: 1, //G?
  iParticleMinimumAlpha: 1, //minimum alpha level to maintain when fading particles
};
